...
public class Artista {
    ...
    private double mediaDasClassificacoes;
    private Date dataDeCriacao = new Date();

    public Artista() { this.atuacoes = new ArrayList<>(); }
    ...
    public void setMediaDasClassificacoes(double mediaDasClassificacoes) {
        this.mediaDasClassificacoes = mediaDasClassificacoes;
    }
    ...
    public double getMediaDasClassificacoes() {
        return mediaDasClassificacoes;
    }
