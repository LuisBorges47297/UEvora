...
#define DURATION_1 0            //instante espera do proccessador, espera 1 intante antes de executar    
#define DURATION_3 2            // esperar 3 intante antes de exe o processo
...
/**
 * Esta funçào executa as tarefas carregadas para a fila com prioridade queue_non_created_of_tasks.
